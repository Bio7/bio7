...
public class BuilderSettingsPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private void addConsoleCheckBox(Composite contents) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(consoleOutputCheckBox, TexlipseHelpIds.BUILDER_CONSOLE);
	}
	...
	/**
	 * Called when defaults-button is pressed. Sets all field values to defaults.
