 ...
 *******************************************************************************/
package com.eco.bio7.reditor.preferences.template;
...
import com.eco.bio7.pythoneditors.TemplateEditorUI;
...
public class PythonCompletionProcessor extends TemplateCompletionProcessor {
	...
	protected TemplateContextType getContextType(ITextViewer viewer, IRegion region) {
		return TemplateEditorUI.getDefault().getContextTypeRegistry().getContextType(PythonContextType.XML_CONTEXT_TYPE);
	}
	...
	protected Image getImage(Template template) {
		...
		if (image == null) {
			ImageDescriptor desc= TemplateEditorUI.imageDescriptorFromPlugin("com.eco.bio7.pythonedit", DEFAULT_IMAGE); //$NON-NLS-1$
