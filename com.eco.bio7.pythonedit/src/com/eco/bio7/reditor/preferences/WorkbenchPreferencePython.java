...
public class WorkbenchPreferencePython extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public WorkbenchPreferencePython() {
		...
		setDescription("Bio7 Python/Jython Editor");
	}
	...
	public void init(IWorkbench workbench) {
		...
		if (isDark) {
			...
			PreferenceConverter.setDefault(store, "colourkey7", new RGB(250, 243, 243));
			PreferenceConverter.setDefault(store, "colourkey8", new RGB(104, 151, 187));
			PreferenceConverter.setDefault(store, "colourkey9", new RGB(250, 243, 243));
	...
	protected void performDefaults() {
		...
		if (editor != null && editor instanceof PythonEditor) {
