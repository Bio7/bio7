 ...
 * toolbar.
 */
public class RActionContributor extends TextEditorActionContributor {
	 ...
	 * Default constructor.
	 */
	public RActionContributor() {
		super();
		fContentAssistProposal = new RetargetTextEditorAction(REditorMessages
