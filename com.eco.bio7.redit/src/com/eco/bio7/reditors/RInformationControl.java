 ...
 * @since 2.0
 */
public class RInformationControl extends DefaultInformationControl  implements DisposeListener {
	...
	public interface IInformationPresenter {
		 ...
		 * @deprecated As of 3.2, replaced by {@link RInformationControl.IInformationPresenterExtension#updatePresentation(Drawable, String, TextPresentation, int, int)}
		 */
	...
	public interface IInformationPresenterExtension {
		 ...
		 * manipulated information.
		 * <p>
		 * Replaces {@link RInformationControl.IInformationPresenter#updatePresentation(Display, String, TextPresentation, int, int)}
	 ...
	 * @since 3.4
	 */
	public RInformationControl(Shell parent, String statusFieldText, IInformationPresenter presenter) {
	 ...
	 * @since 3.4
	 */
	public RInformationControl(Shell parent, ToolBarManager toolBarManager, IInformationPresenter presenter) {
	 ...
	 * @param parent the parent shell
	 */
	public RInformationControl(Shell parent) {
	 ...
	 */
	public RInformationControl(Shell parent, IInformationPresenter presenter) {
	 ...
	 * @param presenter the presenter to be used
	 * @deprecated As of 3.4, replaced by {@link #DefaultInformationControl(Shell, RInformationControl.IInformationPresenter)}
	 */
	public RInformationControl(Shell parent, int textStyles, IInformationPresenter presenter) {
	 ...
	 * @param statusFieldText the text to be used in the status field or <code>null</code> to hide the status field
	 * @since 3.0
	 * @deprecated As of 3.4, replaced by {@link #DefaultInformationControl(Shell, String, RInformationControl.IInformationPresenter)}
	 */
	public RInformationControl(Shell parent, int textStyles, IInformationPresenter presenter, String statusFieldText) {
		super(parent, statusFieldText);
