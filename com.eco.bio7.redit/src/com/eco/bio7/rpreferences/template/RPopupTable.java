 ...
 *      information</a>
 */
public class RPopupTable {
	Shell shell;
	Table table;
	int minimumWidth;
	private String result;
	//private Image imageArgs = new Image(Display.getCurrent(), getClass().getResourceAsStream("/icons/template_obj.png"));
	private Image imageArgs =Bio7REditorPlugin.getImageDescriptor("/icons/template_obj.png").createImage();
	private Image imageVariables = Bio7REditorPlugin.getImageDescriptor("/icons/default_co.png").createImage();
	private Image imageFunctions =  Bio7REditorPlugin.getImageDescriptor("/icons/brkp_obj.png").createImage();
	 ...
	 *            (cannot be null)
	 */
	public RPopupTable(Shell parent) {
		this(parent, 0);
	}
	 ...
	 * @since 3.0
	 */
	public RPopupTable(Shell parent, int style) {
	 ...
	 *                </ul>
	 */
	public void setItems(String[] strings, String type) {

		for (int i = 0; i < strings.length; i++) {
			TableItem item = new TableItem(table, 0);
			item.setText(strings[i]);
			if (type.equals("arguments")) {
				item.setImage(imageArgs);
			} else if (type.equals("variables")) {
				item.setImage(imageVariables);
			} else if (type.equals("functions")) {
				item.setImage(imageFunctions);
			}
		}
