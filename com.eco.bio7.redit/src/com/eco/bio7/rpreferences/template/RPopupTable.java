...
public class RPopupTable {
	...
	private Image imageVariables = new Image(Display.getCurrent(), getClass().getResourceAsStream("/icons/default_co.png"));
	private Image imageFunctions = new Image(Display.getCurrent(), getClass().getResourceAsStream("/icons/brkp_obj.png"));
