...
public class WorkbenchPreferenceR extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, PropertyChangeListener {
	...
	public void init(IWorkbench workbench) {
		...
		PreferenceConverter.setDefault(store, "colourkey5", new RGB(50, 50, 50));
		PreferenceConverter.setDefault(store, "colourkey6", new RGB(50, 50, 50));
		PreferenceConverter.setDefault(store, "colourkey7", new RGB(50, 50, 50));
		PreferenceConverter.setDefault(store, "colourkey8", new RGB(50, 50, 50));
