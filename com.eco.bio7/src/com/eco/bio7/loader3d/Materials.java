...
public class Materials {
	...
	public Materials(String mtlFnm, String directory,GL2 gl) {
		MODEL_DIR = directory;
	...
	/*
	 * The line starts with an MTL word such as Ka, Kd, Ks, and the three floats
	...
	/*
	 * Render using the texture or colours associated with the material,
	 * faceMat. But only change things if faceMat is different from the current
	 * rendering material, whose name is stored in renderMatName.
	 * 
	 * Return true/false if the texture coords need flipping, and store the
	 * current value in a global
	 */
	{
