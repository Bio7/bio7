...
public class ScreenRecording {
	...
	String tmpDir = System.getProperty("java.io.tmpdir") + "3DCapture";
	...
	private Rectangle getCaptureRectangle() {
		top = SpatialStructure.getSpatialStructureInstance().getCanvas();
	...
	public void docaptureAnimationJob() {
		...
		Job job = new Job("Capture 3D Canvas") {

			@Override
			protected IStatus run(IProgressMonitor monitor) {
				monitor.beginTask("Capture 3D Canvas ...", countTo);
				try {
					robot = new Robot();
