...
public class SweavePluginWizard extends Wizard implements INewWizard {
	private SweaveWizardPage page;
	private ISelection selection;

	public SweavePluginWizard() {
		super();
	...
	public void addPages() {
		page = new SweaveWizardPage(selection);
		addPage(page);
	}
