...
public class JavaFXBio7ClassWizard extends Wizard implements INewWizard {
	...
	private void doFinish(String containerName, String fileName,
		...
		try {
			InputStream stream = openContentStreamJavaControllerFile(an1,resource);
	...
	private InputStream openContentStreamJavaFile(String filename, IResource resource) {
		String linefeed = "\r\n";
		String head="import javafx.fxml.FXML;"+linefeed+"import com.eco.bio7.collection.*;"+linefeed+"import com.eco.bio7.batch.*;"
				+linefeed+linefeed+
	...
	private InputStream openContentStreamJavaControllerFile(String filename, IResource resource) {
		...
		String linefeed = "\r\n";
		String head="import javafx.fxml.FXML;"+linefeed+"import java.net.URL;"+linefeed+"import java.util.ResourceBundle;"
				+linefeed+linefeed+
				"public class PleaseProvideControllerClassName {"+linefeed+linefeed+
				"\t@FXML"+linefeed+
				"\tprivate ResourceBundle resources;" +linefeed+
				"\t@FXML"+linefeed+
				"\tprivate URL location;"+linefeed+
				"\t@FXML"+linefeed+
				"\tpublic void initialize(){" + linefeed + linefeed +
