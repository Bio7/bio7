...
public class JarConfigFileWizard extends Wizard implements INewWizard {
	private JarConfigFileWizardPage page;
	private ISelection selection;

	public JarConfigFileWizard() {
		super();
		setNeedsProgressMonitor(true);
	}

	public void addPages() {
		page = new JarConfigFileWizardPage(selection);
		addPage(page);
	}
	...
	private InputStream openContentStream(String filename) {
		...
		linefeed + "Class-Path: MyLib.jar" +
		linefeed + "Main-Class: MyMainClass" + linefeed;
