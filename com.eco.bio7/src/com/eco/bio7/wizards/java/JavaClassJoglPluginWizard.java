...
public class JavaClassJoglPluginWizard extends Wizard implements INewWizard {
	private JavaClassJoglWizardPage page;
	private ISelection selection;

	public JavaClassJoglPluginWizard() {
		super();
		setNeedsProgressMonitor(true);
	}

	public void addPages() {
		page = new JavaClassJoglWizardPage(selection);
		addPage(page);
	}
	...
	private InputStream openContentStream(String filename) {
		String linefeed = "\r\n";
		String imports = "import com.jogamp.opengl.GL2;" + linefeed + "import com.jogamp.opengl.glu.GLU;" + linefeed + "import com.jogamp.opengl.util.gl2.GLUT;" + linefeed + linefeed;
