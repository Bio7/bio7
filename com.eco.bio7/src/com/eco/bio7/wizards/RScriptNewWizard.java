...
public class RScriptNewWizard extends Wizard implements INewWizard {
	private RScriptNewWizardPage page;
	private ISelection selection;

	public RScriptNewWizard() {
		super();
		setNeedsProgressMonitor(true);
	}

	public void addPages() {
		page = new RScriptNewWizardPage(selection);
		addPage(page);
	}
