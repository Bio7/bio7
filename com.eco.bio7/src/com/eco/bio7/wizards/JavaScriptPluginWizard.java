...
public class JavaScriptPluginWizard extends Wizard implements INewWizard {
	private JavaScriptWizardPage page;
	private ISelection selection;

	public JavaScriptPluginWizard() {
		super();
	...
	public void addPages() {
		page = new JavaScriptWizardPage(selection);
		addPage(page);
	}
