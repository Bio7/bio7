...
public class ImageJPluginWizard extends Wizard implements INewWizard {
	private ImageJPluginWizardPage page;
	private ISelection selection;

	public ImageJPluginWizard() {
		super();
		setNeedsProgressMonitor(true);
	}

	public void addPages() {
		page = new ImageJPluginWizardPage(selection);
		addPage(page);
	}
