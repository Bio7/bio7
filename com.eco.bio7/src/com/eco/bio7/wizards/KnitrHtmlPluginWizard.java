...
public class KnitrHtmlPluginWizard extends Wizard implements INewWizard {
	private KnitrHtmlWizardPage page;
	private ISelection selection;

	public KnitrHtmlPluginWizard() {
		super();
	...
	public void addPages() {
		page = new KnitrHtmlWizardPage(selection);
		addPage(page);
	}
