...
public class Start3d extends Action {
	...
	public Start3d(String text, IWorkbenchWindow window) {
	...
	public void run() {
		if (Quad3dview.isOn() == true) {
			Quad3dview.getAnimator().stop();
			Quad3dview.setOn(false);
		} 
		else if (Quad3dview.isOn() == false) {
			Quad3dview.getAnimator().start();
