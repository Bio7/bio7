...
public class Time {
	...
	public static void Timereset() {
		...
		display.syncExec(new Runnable() {
			...
			public void run() {
				InfoView.getLblTimesteps().setText("Time steps: " + Time.getTime());
				InfoView.getLblMonth().setText(InfoView.getMonth()  + Time.getMonth());
				InfoView.getLblYear().setText(InfoView.getYear()  + Time.getYear());
			}
		});
	 ...
	 * 
	 * @param time
	 *            the nutrient time as an integer value.
	 */
	 ...
	 * 
	 * @param counter
	 *            the counter as an integer value.
	 */
	 ...
	 * 
	 * @param modtime
	 *            the modulo operator as an integer value.
	 */
	...
	/**
	 * A method to rearrange the sequence of the month. This method has to be
	 * used with the setMonthnumber method!
	 * 
	 * @param month
	 *            the month values as a string array.
	 */
	...
	/**
	 * A method which will change the sequence of the month as a number. This
	 * method has to be used with the setMonth method!
	 * 
	 * @param month
	 *            the sequence as an integer array.
	 */
