...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	private String id[] = new String[] { "org.eclipse.ui.views.ResourceNavigator", "org.eclipse.ui.console.ConsoleView",
			"com.eco.bio7.RShell", "com.eco.bio7.rbridge.RTable", "com.eco.bio7.imagej", "com.eco.bio7.ijtoolbar",
			"com.eco.bio7.image_methods", "com.eco.bio7.points", "com.eco.bio7.image.TransferGeometryView",
			"com.eco.bio7.browser.Browser", "com.eco.bio7.worldwind.WorldWindView",
			"com.eco.bio7.worldwind.WorldWindOptionsView", "com.eco.bio7.spatial", "com.eco.bio7.discrete3d.Options3d",
			"com.eco.bio7.control", "com.eco.bio7.spreadsheet", "com.eco.bio7.states", "com.eco.bio7.quadgrid",
			"com.eco.bio7.hexgrid", "com.eco.bio7.linechart", "com.eco.bio7.piechart" };
	...
	private ToolbarCreateProjectAndFiles toolbarCreateProjectAndFiles;
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		/*
		 * start3d = new Start3d("Start/Stop Animation", window); register(start3d);
		 */
	...
	protected void fillMenuBar(IMenuManager menuBar) {
		...
		if (showJDTGui == false) {
			...
			final String[] removeActionSets = new String[] { "org.eclipse.search.searchActionSet",
					...
					"org.eclipse.ui.externaltools.ExternalToolsSet", "org.eclipse.ui.externaltools.ExternalToolsSet",
					...
					"org.eclipse.debug.ui.launchActionSet", "org.eclipse.jdt.ui.JavaElementCreationActionSet",
					"org.eclipse.jdt.ui.JavaActionSet", "org.eclipse.ui.edit.text.actionSet.presentation",
					"org.eclipse.ui.cheatsheets.actionSet", "org.eclipse.ui.externaltools.ExternalToolsSet",
					"org.eclipse.jdt.ui.text.java.actionSet.presentation", "org.eclipse.debug.ui.breakpointActionSet",
		...
		/*
		 * rMenu.add(new Separator()); rMenu.add(openRservePref);
		 */
	...
	protected void fillCoolBar(ICoolBarManager coolBar) {
		...
		toolbar.add(print);
		toolbar.add(toolbarCreateProjectAndFiles);
	...
	public void createScriptSubmenus(File file) {
		...
		/*
		 * Create a submenu form the name without extension and replace a underscore in
		 * the filename!
		 */
