...
public class Reg {
	...
	private static void installRegPath(String path_to_r) {
		...
		if (bool == true) {
			...
			try {
				WinRegistry.writeStringValue(WinRegistry.HKEY_LOCAL_MACHINE, "SOFTWARE\\R-core\\R", "Current Version", "3.0.1");
				WinRegistry.writeStringValue(WinRegistry.HKEY_LOCAL_MACHINE, "SOFTWARE\\R-core\\R", "InstallPath", path_to_r);
				WinRegistry.writeStringValue(WinRegistry.HKEY_LOCAL_MACHINE, "SOFTWARE\\R-core\\R\\3.0.1", "InstallPath", path_to_r);
			} catch (IllegalArgumentException e) {
