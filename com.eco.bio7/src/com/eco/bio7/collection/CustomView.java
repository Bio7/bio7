...
public class CustomView extends ViewPart {//implements ISaveablePart2
	...
	/**
	 * Creates a given JPanel tab inside a custom view embedded in a JavaFX panel
	 * which in turn is embedded in a SWT canvas.
	 * 
	 * @param jpanel a JPanel
	 * @param id     the id and name of the tab.
	 */
	public void setPanelFX(final JPanel jpanel, final String id) {
		setPanelFX(jpanel, id, null);
	}
	 ...
	 * @param id     the id and name of the tab.
	 */
	public void setPanelFX(final JPanel jpanel, final String id, Image image) {
		secId = id;
	 ...
	 * @param model the reference to the instance of the compiled class as
	 *              controller.
	 */
	public void setFxmlCanvas(String id, final String path, final Object model) {
		setFxmlCanvas(id, null, path, model);
	}
	 ...
	 *              controller.
	 */
	public void setFxmlCanvas(String id, Image image, final String path, final Object model) {
	 ...
	 * 
	 * @param id    the id and name of the tab.
	 * @param image the image and of the tab.
	 */
	public void setSceneCanvas(String id, Image image) {
		secId = id;
		Display display = PlatformUI.getWorkbench().getDisplay();
		display.syncExec(new Runnable() {
			public void run() {
