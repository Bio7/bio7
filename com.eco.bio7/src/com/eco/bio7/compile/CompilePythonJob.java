...
class CompilePythonJob extends WorkspaceJob implements IJobChangeListener {
	...
	public CompilePythonJob(String aScript, String source) {
	...
	public IStatus runInWorkspace(IProgressMonitor monitor) {
		...
		ScriptEngine enginePython = ScriptEngineConnection.getScriptingEnginePython();
		if (source == null) {
