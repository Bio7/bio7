...
public class PythonInterpreter {
	...
	private static CompilePythonJob ab;
	 ...
	 */
	private static void pythonInterpret(final String aScript, final String source) {
		if (source == null) {
	...
	public static void interpretJob(final String aScript, final String source) {
		BatchModel.pause();
		ab = new CompilePythonJob(aScript, source);
		ab.setUser(true);
                ab.setName("Jython_Interpret_Job");
