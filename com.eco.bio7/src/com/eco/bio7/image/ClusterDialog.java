...
public class ClusterDialog extends Dialog {
	...
	private Group group;
	protected String selectedAlgor = "clara";
	...
	protected Control createDialogArea(Composite parent) {
		...
		Label lblAlgorithm = new Label(container, SWT.NONE);
		lblAlgorithm.setAlignment(SWT.CENTER);
		GridData gd_lblAlgorithm = new GridData(SWT.LEFT, SWT.BOTTOM, true, false, 1, 1);
		gd_lblAlgorithm.heightHint = 30;
		lblAlgorithm.setLayoutData(gd_lblAlgorithm);
		...
		SelectionListener selectionListener = new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				...
				if (button.getSelection()) {
					selectedAlgor = button.getText();
					// System.out.println(selectedAlgor);
				}
			};
		};
		Button btnClara = new Button(group, SWT.RADIO);
		btnClara.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btnClara.setSelection(true);
		btnClara.setText("clara");
		btnClara.addSelectionListener(selectionListener);

		Button btnKmeans = new Button(group, SWT.RADIO);
		btnKmeans.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btnKmeans.setText("kmeans");
		btnKmeans.addSelectionListener(selectionListener);

		new Label(container, SWT.NONE);
		new Label(container, SWT.NONE);
		numberOfClustersLabel = new Label(container, SWT.NONE);
		GridData gd_numberOfClustersLabel = new GridData(SWT.LEFT, SWT.BOTTOM, true, false, 1, 1);
		...
		GridData gd_euclideanButton = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		GridData gd_onlyTransferButton = new GridData(SWT.FILL, SWT.FILL, true, false, 2, 1);
	...
	protected void buttonPressed(int buttonId) {
		...
		if (buttonId == IDialogConstants.OK_ID) {
			...
			ClusterJob.setAlgorSelection(selectedAlgor);
			ClusterJob.setCluster(spinner.getSelection());
