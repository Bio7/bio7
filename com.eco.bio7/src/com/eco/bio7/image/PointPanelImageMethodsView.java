 ...
 * 
 */
public class PointPanelImageMethodsView extends ViewPart {
	public PointPanelImageMethodsView() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		label1.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, true, false, 1, 1));
		...
		GridData gd_scale1 = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		GridData gd_scale2 = new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1);
		...
		gridData121.grabExcessVerticalSpace = false;
		...
		gridData111.grabExcessVerticalSpace = false;
		...
		lblNewLabel_3.setLayoutData(new GridData(SWT.CENTER, SWT.FILL, true, false, 2, 1));
		...
		final GridData gd_voronoiButton = new GridData(SWT.FILL, SWT.FILL, true, false);
		...
		final GridData gd_delauneyButton = new GridData(SWT.FILL, SWT.FILL, true, false);
		...
		GridData gd_dynamicButton = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		GridData gd_drawAreasButton = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		GridData gd_btnDynamic = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		GridData gd_btnAreas = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1);
		...
		lblNewLabel_4.setLayoutData(new GridData(SWT.CENTER, SWT.FILL, true, false, 2, 1));
		...
		GridData gridData31 = new GridData(SWT.FILL, SWT.FILL, true, false);
		...
		GridData gd_label_1 = new GridData(SWT.FILL, SWT.FILL, true, false, 2, 1);
	...
	private static PointPanelImageMethodsView getImageMethods() {
		return im;
	}
