...
public class ImageRoiSelectionTransferJob extends WorkspaceJob implements IJobChangeListener {
	...
	private static boolean doIncreasingSignature;
	private static boolean doSignatureFromName;
	private static boolean doSignatureFromGroup;
	...
	public static void doSetIncreasingSignature(boolean selIncresing) {
		doIncreasingSignature = selIncresing;

	}

	public static void doSetSignatureFromName(boolean selFromName) {
		doSignatureFromName = selFromName;

	}

	public static void doSetSignatureFromGroup(boolean selFromGroup) {
		doSignatureFromGroup = selFromGroup;
	}
					...
					for (int ro = 0; ro < r.length; ro++) {
						...
						for (int i = 0; i < items.length; i++) {
							...
							if (transferType == 0) {
								...
								l = "layer" + (i + 1);
								//System.out.println(l+" is: "+ layerName);
								try {
	...
	public String replaceWrongWord(String namesInput) {
		...
		names = namesInput.replaceAll(regEx, "_");
