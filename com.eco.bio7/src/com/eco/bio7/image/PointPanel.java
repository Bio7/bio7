...
public class PointPanel extends JPanel implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public void paintComponent(Graphics g) {
		...
		g2.drawLine(0, PointPanelImageMethodsView.getFieldY(), PointPanelImageMethodsView.getFieldX(), PointPanelImageMethodsView.getFieldY());
		g2.drawLine(PointPanelImageMethodsView.getFieldX(), 0, PointPanelImageMethodsView.getFieldX(), PointPanelImageMethodsView.getFieldY());
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getClickCount() == 2) {
			...
			if (x <= PointPanelImageMethodsView.getFieldX() && y <= PointPanelImageMethodsView.getFieldY()) {
	...
	public void mouseDragged(MouseEvent e) {
		...
		if (currentellipse != null) {
			...
			if (x < 0 && y < 0) {
				...
				currentPoint.x = PointPanelImageMethodsView.getFieldX();
				currentPoint.y = 0;
				currentellipse.x = PointPanelImageMethodsView.getFieldX() - (currentellipse.getHeight() / 2);
				currentellipse.y = 0 - (currentellipse.getWidth() / 2);
				...
				currentPoint.x = 0;
				currentPoint.y = PointPanelImageMethodsView.getFieldY();
				currentellipse.x = 0 - (currentellipse.getHeight() / 2);
				currentellipse.y = PointPanelImageMethodsView.getFieldY() - (currentellipse.getWidth() / 2);

			}

			else if (x <= PointPanelImageMethodsView.getFieldX() && y <= PointPanelImageMethodsView.getFieldY()) {
				...
				currentPoint.y = PointPanelImageMethodsView.getFieldY();
				currentellipse.x = PointPanelImageMethodsView.getFieldX() - (currentellipse.getHeight() / 2);
				currentellipse.y = PointPanelImageMethodsView.getFieldY() - (currentellipse.getHeight() / 2);
	...
	public static int[] torus(int x, int y, int dx, int dy) {
		...
		coords[0] = ((y + dy + PointPanelImageMethodsView.getFieldY()) % (PointPanelImageMethodsView.getFieldY()));// modulo,

		coords[1] = ((x + dx + PointPanelImageMethodsView.getFieldX()) % (PointPanelImageMethodsView.getFieldX()));
