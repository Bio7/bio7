...
public class Console extends IOConsole {
	...
	public Console(String title) {
		...
		boolean ascii=store.getBoolean("BIO7_CONSOLE_INTERPRET_ASCII");
		boolean asciiCarriage=store.getBoolean("BIO7_CONSOLE_INTERPRET_CARRIAGE_RETURN");
		this.setHandleControlCharacters(ascii);
		this.setCarriageReturnAsControlCharacter(asciiCarriage);
