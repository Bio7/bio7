...
public class RMarkdownCompletionProcessor implements IContentAssistProcessor {
	...
	public ICompletionProposal[] computeCompletionProposals(ITextViewer viewer, int offset) {
		...
		ICompletionProposal[] result = new ICompletionProposal[27];
		IContextInformation[] resContext=new IContextInformation[27];

		String[] textContext = {"```{r}"+System.lineSeparator()+"```",
				"```{r echo=FALSE}"+System.lineSeparator()+"```" ,
				"```{r eval=FALSE}"+System.lineSeparator()+"```" ,
				"#", "##", "###", "####", "#####", "#####","  ",
				"*italics example*", "_italics example_","**bold example**","__bold example__", "superscript^2^", "~~strikethrough~~", "[link](http:\\bio7.org)", "--", "---", "...", "$E = m*c^{2}$",
				"[](path/myImage.png)", "***",">","* item"+System.lineSeparator()+"\t" +"+ subitem1"+System.lineSeparator()+"\t" +"+ subitem2","1. item"+System.lineSeparator()+"\t" +"+ subitem1"+System.lineSeparator()+"\t" +"+ subitem2"
		...
		String[] text = { "R markdown section",
				...
				"Header 1", "Header 2", "Header 3", "Header 4", "Header 5", "Header 6", "Start a new  paragraph (two spaces at the end of a line)",
				"Italic text", "Italic text", "Bold text", "Bold text" ,"Superscript text", "Strikethrough text", "A link", "Endash", "Emdash", "Ellipsis", "Inline equation",
				"Image", "Horizontal rule/slide break","Block quote","Unordered list","Ordered list"
				,"A table"};
