 ...
 * @since 2.0
 */
public class MarkdownEditorHoverTextmarkerInformationControl extends AbstractInformationControl
	...
	public interface IInformationPresenter {
		 ...
		 *             {@link MarkdownEditorHoverTextmarkerInformationControl.IInformationPresenterExtension#updatePresentation(Drawable, String, TextPresentation, int, int)}
		 */
	...
	public interface IInformationPresenterExtension {
		 ...
		 * <p>
		 * Replaces
		 * {@link MarkdownEditorHoverTextmarkerInformationControl.IInformationPresenter#updatePresentation(Display, String, TextPresentation, int, int)}
	 ...
	 * @since 3.4
	 */
	public MarkdownEditorHoverTextmarkerInformationControl(Shell parent, String statusFieldText,
	 ...
	 * @since 3.4
	 */
	public MarkdownEditorHoverTextmarkerInformationControl(Shell parent, ToolBarManager toolBarManager,
			IInformationPresenter presenter) {
	 ...
	 * @param proposals
	 */
	public MarkdownEditorHoverTextmarkerInformationControl(Shell parent, ICompletionProposal[] proposals,
			String message, MarkdownEditor rEditor) {
	 ...
	 * @param proposals
	 */
	public MarkdownEditorHoverTextmarkerInformationControl(Shell parent, ToolBarManager tbm,
			IInformationPresenter fPresenter2, ICompletionProposal[] proposals, String message,
			MarkdownEditor rEditor) {
	 ...
	 */
	public MarkdownEditorHoverTextmarkerInformationControl(Shell parent, IInformationPresenter presenter) {
	...
	public void setInformation(String content) {
		...
		Font font = JFaceResources.getFontRegistry().get("com.eco.bio7.reditor.markdown.textfont");
		if (proposals != null) {
	...
	public IInformationControlCreator getInformationPresenterControlCreator() {
		return new IInformationControlCreator() {
			...
			public IInformationControl createInformationControl(Shell parent) {
				 ...
				 */
				return new MarkdownEditorHoverTextmarkerInformationControl(parent, (ToolBarManager) tbm, fPresenter,
