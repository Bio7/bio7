...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		if (isDark) {
			...
			PreferenceConverter.setDefault(storeR, "colourkey", new RGB(250, 243, 243));
			PreferenceConverter.setDefault(storeR, "colourkey1", new RGB(167, 236, 33));
			PreferenceConverter.setDefault(storeR, "colourkey2", new RGB(250, 243, 243));
