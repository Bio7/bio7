...
import com.eco.bio7.ijmacro.editor.actions.color.OpenColorHexDialog;
 ...
 * @since 2.0
 */
public class IJMacroColorInformationControl extends AbstractInformationControl implements DisposeListener {
	...
	public interface IInformationPresenter {
		 ...
		 *             {@link IJMacroColorInformationControl.IInformationPresenterExtension#updatePresentation(Drawable, String, TextPresentation, int, int)}
		 */
	...
	public interface IInformationPresenterExtension {
		 ...
		 * <p>
		 * Replaces
		 * {@link IJMacroColorInformationControl.IInformationPresenter#updatePresentation(Display, String, TextPresentation, int, int)}
	 ...
	 * @since 3.4
	 */
	public IJMacroColorInformationControl(Shell parent, String statusFieldText, IInformationPresenter presenter) {
	 ...
	 * @since 3.4
	 */
	public IJMacroColorInformationControl(Shell parent, ToolBarManager toolBarManager, IInformationPresenter presenter) {
	 ...
	 *            the parent shell
	 */
	public IJMacroColorInformationControl(Shell parent) {
	 ...
	 */
	public IJMacroColorInformationControl(Shell parent, IInformationPresenter presenter) {
	 ...
	 *             {@link #DefaultInformationControl(Shell, IJMacroColorInformationControl.IInformationPresenter)}
	 */
	public IJMacroColorInformationControl(Shell parent, int textStyles, IInformationPresenter presenter) {
	 ...
	 * @since 3.0
	 * @deprecated As of 3.4, replaced by
	 *             {@link #DefaultInformationControl(Shell, String, IJMacroColorInformationControl.IInformationPresenter)}
	 */
	public IJMacroColorInformationControl(Shell parent, int textStyles, IInformationPresenter presenter,
	...
	public IInformationControlCreator getInformationPresenterControlCreator() {
		return new IInformationControlCreator() {
			...
			public IInformationControl createInformationControl(Shell parent) {
				...
				return new IJMacroColorInformationControl(parent, (ToolBarManager) tbm, fPresenter);
			}
		};
	}
