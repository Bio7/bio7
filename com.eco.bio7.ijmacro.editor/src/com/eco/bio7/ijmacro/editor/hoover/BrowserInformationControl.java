 ...
 * </p>
 * <p>
 * Moved into this package from <code>org.eclipse.jface.internal.text.revisions.
 ...
 * Current problems:
 * <ul>
 * 	<li>the size computation is too small
 * 	<li>focusLost event is not sent - see https://bugs.eclipse.org/bugs/show_bug.cgi?id=84532
 * </ul>
 * </p>
 * 
 * @since 3.2
...
public class BrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	 ...
	 *
	 * @param parent the parent component used for checking or <code>null if none
	 * @return <code>true if this control is available
	 */
	...
	/**
	 * <code>true iff the browser has completed loading of the last
	...
	/**
	 * The symbolic name of the font used for size computations, or <code>null to use dialog font.
	 * @since 3.4
	 */
	 ...
	 * @param resizable <code>true if the control should be resizable
	 * @since 3.4
	 */
	 ...
	 *            or <code>null if the status field should be hidden
	 * @since 3.4
	 */
	 ...
	 * @param parent the parent shell
	 * @param symbolicFontName the symbolic name of the font used for size computations
	 * @param toolBarManager the manager or <code>null if toolbar is not desired
	 * @since 3.4
	 */
	...
	public Point computeSizeHint() {
		...
		// Furthermore, the indentation of <dl> elements is too small (e.g with a long @see line)
	...
	//Changed for Bio7!
    	...
    	*/
    	 ...
    	 * 
    	 * @return <code>true iff a delayed input change
    	 ...
    	 * 
    	 * @param newInput the new input, or <code>null to request cancellation
    	 * @since 3.4
    	 */
    	...
    	/**
    	 * @return the current browser input or <code>null
    	 */
    	...
    	public IInformationControlCreator getInformationPresenterControlCreator() {
    		return new IInformationControlCreator() {
    			...
    			public IInformationControl createInformationControl(Shell parent) {
    				return new BrowserInformationControl(parent,"Arial",true);
    			}
    		};
    	}
    }
