...
public class NewtEventConverterAWT {
	...
	static {
		...
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_OPENED,
		// java.awt.event.WindowEvent.WINDOW_OPENED);
		map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_DESTROY_NOTIFY,
				java.awt.event.WindowEvent.WINDOW_CLOSING);
		map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_DESTROYED, java.awt.event.WindowEvent.WINDOW_CLOSED);
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_ICONIFIED,
		// java.awt.event.WindowEvent.WINDOW_ICONIFIED);
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_DEICONIFIED,
		// java.awt.event.WindowEvent.WINDOW_DEICONIFIED);
		// map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_GAINED_FOCUS,
		...
		// map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_LOST_FOCUS,
		...
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_STATE_CHANGED,
		...
		map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_RESIZED,
				java.awt.event.ComponentEvent.COMPONENT_RESIZED);
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_SHOWN,
		// java.awt.event.ComponentEvent.COMPONENT_SHOWN);
		// n/a map.put(com.jogamp.newt.event.WindowEvent.EVENT_WINDOW_HIDDEN,
	 ...
	 * 
	 * @param newtMods NEWT modifiers mask
	 ...
	 * @param awtSourceComponent Component to set as the AWT event source
	...
	public static final java.awt.event.KeyEvent createKeyEvent(com.jogamp.newt.event.KeyEvent event,
		...
		if (id != KEY_NOT_FOUND_VALUE) {
			...
			// can never be java.awt.event.KeyEvent.VK_UNDEFINED or
			// java.awt.event.KeyEvent.KEY_LOCATION_UNKNOWN,
			// because id will never be java.awt.event.KeyEvent.KEY_TYPED (doesn't exist in
			// map)
			...
			try {
				...
				// ignore - sometimes can raise an: java.lang.IllegalArgumentException: invalid
				// keyChar
			}
		}
		return null; // no mapping ..
	...
	/**
	 * Interface which all AWT events created by the {@link NewtEventConverterAWT}
	 * implement. Provides access to the original NEWT event from which the AWT
	 * event was created.
	 */
	public interface AWTEventFromNewt {
		/**
		 * @return The original NEWT event from which this AWT event was created.
		 */
	...
	public static class MouseWheelEventFromNewt extends java.awt.event.MouseWheelEvent implements AWTEventFromNewt {
		...
		public MouseWheelEventFromNewt(NEWTEvent originalEvent, Component source, int id, long when, int modifiers,
				int x, int y, int clickCount, boolean popupTrigger, int scrollType, int scrollAmount,
				int wheelRotation) {
