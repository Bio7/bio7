...
/*Source adapted from: http://www.eclipse.org/articles/Article-Field-Editors/field_editors.html*/
import java.util.*;
...
public class AddRemoveListFieldEditor extends FieldEditor {
	...
	protected void doLoad() {
		String items = Bio7EditorPlugin.getDefault().getPreferenceStore().getString(getPreferenceName());
		setList(items);
	}
	...
	protected void doLoadDefault() {
		String items = Bio7EditorPlugin.getDefault().getPreferenceStore().getDefaultString(getPreferenceName());
		setList(items);
	}
	...
	protected void doStore() {
		...
		if (s != null)
			Bio7EditorPlugin.getDefault().getPreferenceStore().setValue(getPreferenceName(), s);
	}
