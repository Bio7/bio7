...
public class JavaCompletionProcessor extends TemplateCompletionProcessor {
	...
	protected TemplateContextType getContextType(ITextViewer viewer, IRegion region) {
		return TemplateEditorUI.getDefault().getContextTypeRegistry().getContextType(JavaContextType.XML_CONTEXT_TYPE);
	}
	...
	protected Image getImage(Template template) {
		...
		if (image == null) {
			ImageDescriptor desc= TemplateEditorUI.imageDescriptorFromPlugin("com.eco.bio7.javaedit", DEFAULT_IMAGE); //$NON-NLS-1$
