 ...
 */
public class DynamicCompilerJavaModules extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public DynamicCompilerJavaModules() {
		super();
	...
	protected Control createContents(Composite parent) {
		...
		listLabel.setText("Add modules path for dynamic compilation (--module-path)");
		...
		lblAddModules.setText("Add modules (--add-modules)");
	...
	public String[] getDefaultExemptTagsPreference() {
		return convert(Bio7EditorPlugin.getDefault().getPreferenceStore().getDefaultString("JAVA_MODULES_PATH"));
	}
