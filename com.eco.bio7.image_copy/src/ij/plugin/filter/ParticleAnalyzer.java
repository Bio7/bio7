...
public class ParticleAnalyzer implements PlugInFilter, Measurements {
	...
	/**
	 * Display image containing grayscales masks that identify measured
	 * particles.
	 */
	...
	protected static final int NOTHING = 0, OUTLINES = 1, BARE_OUTLINES = 2, ELLIPSES = 3, MASKS = 4, ROI_MASKS = 5, OVERLAY_OUTLINES = 6, OVERLAY_MASKS = 7;
	 ...
	 * 
	 * @param options
	 *            a flag word created by Oring SHOW_RESULTS,
	 *            EXCLUDE_EDGE_PARTICLES, etc.
	 * @param measurements
	 *            a flag word created by ORing constants defined in the
	...
	/**
	 * Returns the "Outlines", "Masks", "Elipses" or "Count Masks" image, or
	 * null if "Nothing" is selected in the "Show:" menu.
	 */
	...
	/**
	 * Sets the color ("blue", "black", etc.) of the font used to label outlines
	 * in the next particle analyzer instance.
	 */
	 ...
	 * There is a JavaScript example at
