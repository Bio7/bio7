/* $Id: AwtEnvironment.java,v 1.24 2008/05/02 18:38:17 ghirsch Exp $ */
/*******************************************************************************
...
public final class AwtEnvironment {
	...
	public AwtEnvironment(final Display display) {
		assert display != null;
	...
	private static final boolean HIDE_SWING_POPUPS_ON_SWT_MENU_OPEN = (Platform.isGtk() && Platform.JAVA_VERSION < Platform.javaVersion(1, 6, 0)) || // GTK:
																																						// pre-Java1.6
	...
	public void invokeAndBlockSwt(final Runnable runnable) {
		 ...
		 * http://dev.eclipse.org/newslists/news.eclipse
		 * .platform.swt/msg24234.html
		 */
		if (runnable == null) {
			SWT.error(SWT.ERROR_NULL_ARGUMENT);
		}
