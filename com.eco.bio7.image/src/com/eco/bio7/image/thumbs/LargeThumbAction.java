...
public class LargeThumbAction extends Action {

	public LargeThumbAction() {
		super("Large", AS_CHECK_BOX);
	...
	public void run() {
		...
		ThumbnailsView.getThumb().setSize("large");
		ThumbnailsView.getThumb().getLarge().setChecked(true);
