...
public class ImagePlus implements ImageObserver, Measurements, Cloneable {
	 ...
	 * class overrides this method so it returns the processor associated with
	 * the current channel.
	 */
	 ...
	 * (auto-scaling), 8 (0-255), 10 (0-1023), 12 (0-4095, 15 (0-32767) or 16
	 * (0-65535).
	 */
	...
	/**
	 * Returns the default 16-bit display range, 0 (auto-scaling), 8, 10, 12, 15
	 * or 16.
	 */
